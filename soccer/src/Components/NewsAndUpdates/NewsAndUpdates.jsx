  ...
  return (
    ...
    <div className='newsupdate-sections'>
      <div className='left-section'>
        ...
        <div className='news-one'>Player of the Month:<br/>
        ...
        <div className='news-one'>New Training Sessions Introduced:<br/>
        ...
        <div className='news-one'>Academy Alumni Success:<br/>
